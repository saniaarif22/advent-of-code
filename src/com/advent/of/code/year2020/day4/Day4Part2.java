package com.advent.of.code.year2020.day4;
...
public class Day4Part2 {
    ...
    System.out.println("Number of invalid passports: " + invalid);
  }

  private static boolean isValid(Map<String, String> passportMap) {
      if ((passportMap.containsKey("cid") && passportMap.keySet().size() == 8) ||
          (!passportMap.containsKey("cid") && passportMap.keySet().size() == 7)) {
        try {
          int byr = Integer.parseInt(passportMap.get("byr"));
          int iyr = Integer.parseInt(passportMap.get("iyr"));
          int eyr = Integer.parseInt(passportMap.get("eyr"));
          String hgt = passportMap.get("hgt");
